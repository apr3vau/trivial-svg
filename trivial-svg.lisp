  ...
  (let ((tag (plump-dom:tag-name node))
    ...
    (labels ((get-attr (key)
               (svg-parse-attribute-by-name
                ...
                state container-attributes root-node))
             (run-draw-path (trans-origin-x trans-origin-y path)
               ...
               (let* ((transform (make-transform))
                      ...
                      (fill (get-attr "fill"))
                      (stroke (get-attr "stroke"))
                      (stroke-width (or (get-attr "stroke-width") 1))
                      (linecap (string-case ((get-attr "stroke-linecap"))
                                 ("round" :round)
                                 ("square" :square)
                                 (t :butt)))
                      (linejoin (string-case ((get-attr "stroke-linejoin"))
                                  ("round" :round)
                                  ("bevel" :bevel)
                                  (t :miter)))
                      (dash (get-attr "stroke-dasharray"))
                      (fill-rule (get-attr "fill-rule")))
      ...
      (string-case (tag)
        ...
        ("line" (let ((x1 (get-attr "x1")) (y1 (get-attr "y1"))
                      (x2 (get-attr "x2")) (y2 (get-attr "y2")))
